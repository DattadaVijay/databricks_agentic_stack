# databricks_agentic_stack

The 'databricks_agentic_stack' project was generated by using the default-python template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] databricks_agentic_stack_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/databricks_agentic_stack.job.yml). The schedule
